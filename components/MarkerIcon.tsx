...
export const MarkerIcon = ({color = "red", scaleFactor}: MarkerIconProps) => {
  return L.divIcon({
    ...
    html: `<div class="relative w-[29px] h-[45px] min-w-[29px] min-h-[45px]">
        ...
        <div class="absolute text-[${color}] text-center top-[6px] w-full text-xs font-mono">${scaleFactor.toFixed(1)}</div>
      </div>`,
    iconSize: [25, 41],
    iconAnchor: [12.5, 41],
    popupAnchor: [1, -34],
